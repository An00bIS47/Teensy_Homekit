...
enum HAP_ENCRYPTION_MODE {
	HAP_ENCRYPTION_MODE_PLAIN,
	HAP_ENCRYPTION_MODE_PLAIN_CHUNKED,
	HAP_ENCRYPTION_MODE_DECRYPT,
	HAP_ENCRYPTION_MODE_DECRYPT_CHUNKED,
	HAP_ENCRYPTION_MODE_ENCRYPT,
	HAP_ENCRYPTION_MODE_ENCRYPT_CHUNKED
};
